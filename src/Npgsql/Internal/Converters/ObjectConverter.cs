...
sealed class ObjectConverter : PgStreamingConverter<object>
{
    ...
    protected override bool IsDbNullValue(object? value, ref object? writeState)
    {
        ...
        if (typeInfo.GetConcreteResolution().Converter.IsDbNullAsObject(value, ref effectiveState))
            return true;
    ...
    public override Size GetSize(SizeContext context, object value, ref object? writeState)
    {
        ...
        var converter = typeInfo.GetConcreteResolution().Converter;
        ...
        var result = typeInfo.GetConcreteResolution().Converter.GetSizeAsObject(context, value, ref effectiveState);
    ...
    sealed class WriteState
    {
        ...
        public required object EffectiveState { get; init; }
    }
}
